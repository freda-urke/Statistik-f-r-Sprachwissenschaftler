...
Es gibt doppelt so viele Möglichkeiten durchzufallen - in totalen Zahlen: 3 Noten für den Einer-Bereich und 6 Noten für den Durchgefallen-Bereich. Bei einer Änderung der Standardabweichung von relativ eng um den Mittelwert verteilt (s=3) über eine mittlere Standardabweichung um den Mittlwert (s=4) zu einer verhältnismäßig weiten Verteilung um den Mittwelwert (s=5), steigt die Möglichkeit durchzufallen "gleichmäßig" mit der Erhöhung der Standardabweichung.  
