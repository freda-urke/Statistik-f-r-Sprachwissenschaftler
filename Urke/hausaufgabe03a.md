...
- Thematisierung von Variablen und Testbedingungen
- Erörterung, wann man welchen Test aus welchen Gründen nutzt.
...
# Normaler R-Code 
Es ist natürlich auch möglich R-Code zu schreiben, ohne ihn in (R)Markdown einzubetten. Dazu geht die Aufgabe weiter mit `hausaufgabe03b.R`. Sie sollten die Datei auch in Ihren Ordner kopieren und einen Commit machen, bevor Sie die Kopie weiter anpassen.
