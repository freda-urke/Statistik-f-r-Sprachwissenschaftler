...
# Nein, es gibt kann auch mehrere Modalwerte bzw. multimodale Häufigkeitsverteilungen geben. Da bei uns aber nur zwei
# Merkmale vorhanden sind und einer der beiden häufiger vorkommt, als der andere, kann es bei uns nur einen Modalwert 
# geben. Aus diesem Grund ist die obige Formel für unsere Rechnung hier korrekt. 
